...
public class Test {
  ...
  public static void main(String [] args) {
    ...
    System.out.println("Actual output from recursi  ve algorithm (optimized for sorted input):");
    System.out.println(Arrays.toString(ArrayIntersect.sortedArrayIntersection(arr1, arr2)));
    System.out.println("Nicht sortierte rekursive Aufrufe: " + ArrayIntersect.recursiveCallsNonSorted);
    System.out.println("Sortierte rekursive Aufrufe: " + ArrayIntersect.recursiveCallsSorted);
  }
}
